...
#. Create an encryption key
    ...
    .. code-block:: console
            ...
            docker run python:3.7-alpine python -c "import os; print(os.urandom(32).hex())" | docker secret create encryption_key -
...
#. Navigate to the default IP and port. The default IP and the port can be changed in the server. Configuration settings will be saved in the ``common/config.py`` file.
