...
export class SettingsService {
	...
	getConfiguration(): Promise<Configuration> {
		return this.http.get('/walkoff/api/configuration')
			.toPromise()
	...
	updateConfiguration(configuration: Configuration): Promise<Configuration> {
		return this.http.put('/walkoff/api/configuration', configuration)
			.toPromise()
			.then((data: object) => plainToClass(Configuration, data))
			.catch(this.utils.handleResponseError);
	}
	...
	getUsers(page: number = 1): Promise<User[]> {
		return this.http.get(`/walkoff/api/users?page=${ page }`)
			.toPromise()
	...
	addUser(user: User): Promise<User> {
		return this.http.post('/walkoff/api/users', user)
			.toPromise()
			.then((data: object) => plainToClass(User, data))
			.catch(this.utils.handleResponseError);
	}
	...
	editUser(user: User): Promise<User> {
		return this.http.put('/walkoff/api/users', user)
			.toPromise()
			.then((data: object) => plainToClass(User, data))
			.catch(this.utils.handleResponseError);
	}
	...
	deleteUser(id: number): Promise<void> {
		return this.http.delete(`/walkoff/api/users/${id}`)
			.toPromise()
			.then(() => null)
			.catch(this.utils.handleResponseError);
	}
	...
	getRoles(): Promise<Role[]> {
		return this.http.get('/walkoff/api/roles')
			.toPromise()
	...
	addRole(role: Role): Promise<Role> {
		return this.http.post('/walkoff/api/roles', role)
			.toPromise()
			.then((data: object) => plainToClass(Role, data))
			.catch(this.utils.handleResponseError);
	}
	...
	editRole(role: Role): Promise<Role> {
		return this.http.put('/walkoff/api/roles', role)
			.toPromise()
			.then((data: object) => plainToClass(Role, data))
			.catch(this.utils.handleResponseError);
	}
	...
	deleteRole(id: number): Promise<void> {
		return this.http.delete(`/walkoff/api/roles/${id}`)
			.toPromise()
			.then(() => null)
			.catch(this.utils.handleResponseError);
	}
	...
	getAvailableResourceActions(): Promise<AvailableResourceAction[]> {
		...
		return this.http.get('/walkoff/api/availableresourceactions')
			.toPromise()
