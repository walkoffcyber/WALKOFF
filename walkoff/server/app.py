...
def register_blueprints(flaskapp, separate_interfaces=False):
    ...
    flaskapp.register_blueprint(custominterface.custom_interface_page, url_prefix='/walkoff/custominterfaces/<interface>')
    flaskapp.register_blueprint(workflowresults.workflowresults_page, url_prefix='/walkoff/api/streams/workflowqueue')
    flaskapp.register_blueprint(notifications.notifications_page, url_prefix='/walkoff/api/streams/messages')
    flaskapp.register_blueprint(console.console_page, url_prefix='/walkoff/api/streams/console')
    flaskapp.register_blueprint(root.root_page, url_prefix='/walkoff')
